...
namespace CornellTech.View
{
	...
	public class Planet : MonoBehaviour
	{
		...
		public void Reset()
		{
			...
			this.rigidbody.transform.localPosition = new Vector3 (0.0f, 0.0f, 0.0f);
			this.rigidbody.transform.localRotation = Quaternion.identity;
		}
		...
		protected void UpdateOrbit ()
		{
			...
			//TODO:Fill.
//			this.transform.RotateAround(sunTransform.position, sunTransform.up, myPlanetData.revolutionPeriod / Time.deltaTime);
			this.transform.RotateAround(sunTransform.position, sunTransform.up, RevolutionPeriodToAngle(myPlanetData.revolutionPeriod));
		}
		...
		protected void UpdateRotation ()
		{
			//TODO:Fill.
			PlanetData myPlanetData = planetData [planetType];
//			this.transform.RotateAround(transform.position, transform.up, Time.deltaTime * myPlanetData.rotationPeriod / Time.deltaTime);
			this.transform.RotateAround(transform.position, transform.up, RotationPeriodToAngle(myPlanetData.rotationPeriod));
		}
